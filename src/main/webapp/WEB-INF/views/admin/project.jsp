            ...
            <div class="row ">
                ...
                <div class="form-horizontal clearfix">
                    <div class="col-lg-4 col-sm-3 pl0">
                        <button class="btn btn-success" data-toggle="modal" data-target="#add-modal"><i class="glyphicon glyphicon-plus"></i>&nbsp;添加项目</button>
                    </div>
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="edit-form">
                    ...
                    <div class="form-group">
                        <label for="edit-comments" class="col-sm-2 control-label">详细</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="comments" id="edit-comments" cols="12" rows="6"
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="add-form">
                    ...
                    <div class="form-group">
                        <label for="edit-comments" class="col-sm-2 control-label">详细</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="comments" id="add-comments" cols="12" rows="6"
                                      placeholder="请输入详细介绍"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function showInfo(item) {
        ...
        $("#info-modal table tr:eq(2) td:eq(1) p").html(item.comments);
    }
    ...
    function editInfo(item) {
        ...
        $("#edit-comments").val(item.comments);
    }
